# End-to-End SQLite3 C API

Working with SQLite3 via C is the **fastest** way to interact with it.

- And, in *my opinion*, the easiest.
...
can create a seamless cross-platform CLI for developers, as well as
implementing CI, linters, static and dynamic analysers, *fuzzers*, etc,. to
**fully test and confirm everything possible**.
